========================================================================
    KONSOLENANWENDUNG: Temperature Converter-Projektübersicht
========================================================================

Diese Temperature Converter-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Temperature Converter-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Temperature Converter.pch und eine 
